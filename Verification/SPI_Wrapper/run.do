vlib work
vlog project_ram.v project_spi.v RAM_Golden.v spi_slave_golden.v SPI_Wrapper_Golden.v top.sv interface.sv \
enviroment.sv test.sv driver.sv config.sv agent.sv coverage_collector.sv monitor.sv scoreboard.sv seq_item.sv sequence.sv sequencer.sv \
SPI_assertions.sv spi_wrapper.sv +cover -covercells
...
run -all
quit -sim
vcover report SPI.ucdb -details -annotate -all -output coverage_rpt.txt